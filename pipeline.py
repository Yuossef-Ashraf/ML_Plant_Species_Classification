"""
Production Machine Learning Pipeline for Botanical Plant Species Classification & Thriving Predictor.
...
def train_and_evaluate(csv_path: str = "plants_dataset_euhm_itai_07.csv"):
...
def main():
    parser = argparse.ArgumentParser(description="Botanical Plant Species Classification & Thriving Predictor CLI")
    parser.add_argument("--data", type=str, default="plants_dataset_euhm_itai_07.csv", help="Path to CSV dataset")
